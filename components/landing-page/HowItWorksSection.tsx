...
export default function HowItWorksSection({ clerkId, setupDone }: HowItWorksSectionProps) {
  return (
    <section id="how-it-works" className="relative py-0 overflow-hidden text-on-surface">
      {/* Background Elements */}
      ...
      <div className="container max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
        <SectionHeading
          ...
          title="How Clutchly works"
          subtitle="From your resume to personalized interview coaching in just a few minutes."
        />

        {/* Steps Container */}
        <div className="relative space-y-24 md:space-y-32">
          {/* Central Line (Desktop Only) */}
          <div className="hidden md:block absolute left-1/2 top-0 -translate-x-1/2 w-[2px] h-full bg-primary/25 pointer-events-none"></div>
              ...
              <div className="relative w-full max-w-sm aspect-video bg-white rounded-xxl premium-shadow border border-outline-variant p-md flex items-center justify-center overflow-hidden">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="w-24 h-32 bg-white rounded-lg border-2 border-primary border-dashed flex flex-col items-center justify-center p-3 shadow-md transform rotate-3 relative">
                    ...
                    {/* Scanning line */}
                    <div className="absolute inset-x-0 top-1/2 h-[2px] bg-primary/50"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-lg md:gap-xl">
            <div className="flex-1 order-1 flex justify-center md:justify-end">
              <div className="relative w-full max-w-sm h-64 bg-on-background rounded-xxl premium-shadow p-lg flex flex-col items-center justify-center">
                ...
                <div className="flex items-end gap-1 h-12 mb-sm">
                  ...
                  <div className="w-1 bg-primary/60 rounded-full h-8"></div>
                  <div className="w-1 bg-primary rounded-full h-12"></div>
                  <div className="w-1 bg-primary/80 rounded-full h-6"></div>
                  <div className="w-1 bg-primary/40 rounded-full h-4"></div>
                </div>
                <span className="font-label-md text-primary uppercase tracking-widest">Speaking</span>
              </div>
            </div>
            
            <div className="flex-1 order-2 text-center md:text-left">
              ...
              <div className="relative w-full max-w-sm bg-white rounded-xxl premium-shadow border border-outline-variant p-md overflow-hidden">
                <div className="relative h-40">
                  ...
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 150">
                    ...
                    <circle cx="350" cy="30" fill="#635BFF" r="10"></circle>
                  </svg>
                  {/* Labels */}
            ...
            <div className="relative z-10">
              {!clerkId && (
                <SignUpButton mode="modal">
                  <button className="bg-primary text-white px-xl py-4 rounded-full font-label-md text-label-md flex items-center gap-2 hover:opacity-90 active:scale-95 transition-all duration-200 premium-shadow cursor-pointer">
